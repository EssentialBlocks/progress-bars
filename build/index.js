...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Edit, [{
    ...
    value: function render() {
      ...
      var wrapperStyles = {
        paddingTop: displayPercentage && percentageType === "tooltip" ? _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_HEIGHT"] : 0
      };
      var containerStyle = {
        backgroundColor: progressBackground || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_BACKGROUND"],
        height: "".concat(height || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_HEIGHT"]).concat(heightUnit)
      };
      var titleStyles = {
        visibility: displayTitle ? "visible" : "hidden",
        fontSize: "".concat(titleFontSize).concat(titleFontSizeUnit),
      ...
      var progressStyle = {
        backgroundColor: colorType === "fill" ? progressColor : _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_PROGRESS_COLOR"],
        width: "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_PROGRESS"], "%"),
        backgroundImage: colorType === "gradient" ? progressGradient : "none"
      };
      var tooltipStyles = {
        display: displayPercentage && percentageType == "tooltip" ? "block" : "none",
        backgroundColor: tooltipBackground || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_TOOLTIP_COLOR"],
        color: percentageColor || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_TOOLTIP_TEXT_COLOR"]
      };
      var tooltipArrowStyles = {
        borderTop: "5px solid ".concat(tooltipBackground || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_TOOLTIP_COLOR"])
      };
      ...
      return [isSelected && /*#__PURE__*/React.createElement(_inspector__WEBPACK_IMPORTED_MODULE_3__["default"], this.props), /*#__PURE__*/React.createElement("div", {
        className: "eb-progressbar-wrapper",
        style: wrapperStyles
      }, /*#__PURE__*/React.createElement("div", {
        className: "eb-progressbar-container",
        ...
        style: tooltipStyles
      }, "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_PROGRESS"], "%"), /*#__PURE__*/React.createElement("span", {
        ...
        style: titleStyles,
        value: title,
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Enter text"),
      ...
      }, "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_PROGRESS"], "%")))))];
    }
  }]);
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])("block/progress-bars", {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("Progress Bars", "block"),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("Make your website interactive with stunning progress bar", "block"),
  category: "widgets",
...
var Inspector = function Inspector(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["InspectorControls"], {
    key: "controls"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"], null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["RangeControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Progress"),
    value: progress || _constants__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_PROGRESS"],
    allowReset: true,
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Height"),
    value: height || _constants__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_HEIGHT"],
    allowReset: true,
    onChange: function onChange(newValue) {
      return setAttributes({
        height: newValue
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Display Percentage"),
  ...
  }), displayPercentage && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["ToggleControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Inline percentage"),
    checked: percentageType === "inline",
    onChange: function onChange() {
      return percentageType === "inline" ? setAttributes({
        percentageType: "tooltip"
      }) : setAttributes({
        percentageType: "inline"
      });
    }
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["ToggleControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Gradient Color"),
    checked: colorType === "gradient",
    onChange: function onChange() {
      return colorType === "fill" ? setAttributes({
        colorType: "gradient"
      }) : setAttributes({
        colorType: "fill"
      });
    }
  }), displayTitle && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["BaseControl"], {
    ...
    initialOpen: false
  }, displayTitle && /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
  ...
  }), displayPercentage && percentageType === "tooltip" && /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Tooltip Background"),
    color: tooltipBackground,
    onChange: function onChange(tooltipBackground) {
      return setAttributes({
        tooltipBackground: tooltipBackground
      });
    }
  }), displayPercentage && percentageType === "tooltip" && /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Percentage Color"),
    color: percentageColor,
    onChange: function onChange(percentageColor) {
      return setAttributes({
    ...
    onChange: function onChange(progressBackground) {
      return setAttributes({
        progressBackground: progressBackground
      });
    }
  }), colorType == "fill" && /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Progressbar Color"),
    color: progressColor,
  ...
  }), colorType === "gradient" && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"], {
...
var save = function save(_ref) {
  ...
  var progress = attributes.progress,
      ...
      titleLetterSpacingUnit = attributes.titleLetterSpacingUnit;
  var wrapperStyles = {
    paddingTop: displayPercentage && percentageType === "tooltip" ? _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_HEIGHT"] : 0
  };
  var containerStyle = {
    backgroundColor: progressBackground || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_BACKGROUND"],
    height: "".concat(height || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_HEIGHT"]).concat(heightUnit)
  };
  var titleStyles = {
    visibility: displayTitle ? "visible" : "hidden",
    fontSize: "".concat(titleFontSize, "px"),
  ...
  var progressStyle = {
    backgroundColor: colorType === "fill" ? progressColor : _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_PROGRESS_COLOR"],
    width: "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_PROGRESS"], "%"),
    backgroundImage: colorType === "gradient" ? progressGradient : "none",
    fontSize: "".concat(titleFontSize, "px")
  };
  var tooltipStyles = {
    display: displayPercentage && percentageType == "tooltip" ? "block" : "none",
    backgroundColor: tooltipBackground || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_TOOLTIP_COLOR"],
    color: percentageColor || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_TOOLTIP_TEXT_COLOR"]
  };
  var tooltipArrowStyles = {
    borderTop: "5px solid ".concat(tooltipBackground || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_TOOLTIP_COLOR"])
  };
  var innerProgressStyle = {
    display: displayPercentage && percentageType == "inline" ? "block" : "none",
    paddingRight: 8,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eb-progressbar-tooltip",
    style: tooltipStyles
  }, "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_PROGRESS"], "%"), /*#__PURE__*/React.createElement("span", {
    className: "eb-progressbar-tooltip-arrow",
    style: tooltipArrowStyles
    ...
    style: innerProgressStyle
  }, "".concat(progress || _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_PROGRESS"], "%")))));
};
